    ...
    <div class="container">
       ...
       <form class= "formulario" method="POST" enctype="multipart/form-data" action="upload.php">
        ...
        <table class="cadastro">
            ...
            <tr><td><label>Nome do autor:<br><input type="text" name="nomeautor" value="" /></label><br><br></td>
            ...
            <tr><td><label>Preço R$:<br><input type="text" name="preco" value="" /></label><br><br></td>
